...
runEval :: (Q Name -> Stack VType -> Stack Value -> (Value -> m r) -> m r) -> (a -> m r) -> Eval m a -> m r
runEval hdl k (Eval m) = m hdl k

newtype Eval m a = Eval (forall r . (Q Name -> Stack VType -> Stack Value -> (Value -> m r) -> m r) -> (a -> m r) -> m r)
